  ...
  const faqs = [
    {
      ...
      answer:
        "Healty is a web app designed to help you build healthier habits. By analyzing your health data, lifestyle, and medical history, our AI recommends personalized habits to improve your well-being.",
    },
    {
        ...
        <section className=" min-h-screen relative">
          <div className="grid md:grid-cols-2 grid-cols-1 gap-5 mt-[14rem]">
            <div className="space-y-5 ">
              <h1 className="font-black text-7xl text-secondary-foreground">
                Upgrade Your
                <br />
